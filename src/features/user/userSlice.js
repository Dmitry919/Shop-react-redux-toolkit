...
const addCurentUser = (state, { payload }) => {
...
const userSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        // });
        builder.addCase(createUser.fulfilled, addCurentUser);
        builder.addCase(loginUser.fulfilled, addCurentUser);
        builder.addCase(updateUser.fulfilled, addCurentUser);
