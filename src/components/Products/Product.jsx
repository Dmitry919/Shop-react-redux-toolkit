    ...
    <section className={styles.product}>
        <div className={styles.images}>
            ...
            <div className={styles["images-list"]}>
                {images.map((image, i) => (
                    <div className={styles.image} key={i} style={{backgroundImage: `url(${image})`}} onClick={() => setCurrentImage(image)}/>
                ))}
            </div>
        </div>
        ...
        <div className={styles.info}>
                ...
                <div className={styles.sizes}>
                    ...
                    <div className={styles.list}>
                        {SIZES.map((size) => (
                            <div className={`${styles.size} ${currentSize === size ? styles.active : ""}`} key={size} onClick={() => setCurrentSize(size)}>
                                {size}
                            </div>
                        ))}
                    </div>
